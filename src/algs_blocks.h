...
static inline void rect_fw_init(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t end_i) {
    T_(0, 0) = DIST(a[0], b[0]);
    // the first row
    for (int j = 1; j < m; j++)
...
static inline void rect_fw_block(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t start_i, size_t end_i, size_t start_j, size_t end_j) {
...
static inline void rect_bw_init(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t end_i) {
...
static inline void rect_bw_block(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t start_i, size_t end_i, size_t start_j, size_t end_j) {
...
static inline void rect_fr_init(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t end_i, size_t offset_i) {
...
static inline void rect_fr_block(seq_t a, size_t n, seq_t b, size_t m, tab_t t, size_t start_i, size_t end_i, size_t start_j, size_t end_j, size_t offset_i) {
    for (int i = start_i; i < end_i; i++) {
